...
public class ChitietHd extends javax.swing.JPanel {
    ...
    private void loadsp() throws  SQLException{
        ...
        List<goiysanpham> listComboBox = spDAO.getAllForComboBox();
    ...
    try {
        ...
        double giaban = selectedSP.getDongia();

        // 3. KIỂM TRA SỐ LƯỢNG - DÙNG VALIDATION CÓ SẴN
        String soLuongStr = txtsl.getText();
        
        
        if (soLuongStr.isEmpty()||!validate.isInteger(soLuongStr)) {
        ...
        if (!validate.isPositiveInteger(soLuongStr)) {
        ...
        if (madh.isEmpty()||!validate.isPositiveInteger(madh)) {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(7, 7, 7)
                            .addComponent(txtsl, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE))
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
