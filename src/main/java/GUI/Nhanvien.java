...
public class Nhanvien extends javax.swing.JPanel {
    ...
    private void themnv(){
        ...
        if(!validate.isPositiveInteger(txtmanv.getText())){
            JOptionPane.showMessageDialog(this, "Mã nhân viên phải là số nguyên dương");
            txtmanv.requestFocus();
            return;
        }
        if(!validate.isInteger(txtmanv.getText())||!validate.isValidPhoneNumber(txtsdt.getText())){
            JOptionPane.showMessageDialog(this, "Sdt phải là số nguyên");
            txtsdt.requestFocus();
            txtmanv.requestFocus();
            return;
        }
        if(!validate.isValidPhoneNumber(txtsdt.getText())){
    ...
    private void suanv(){
        ...
        if(!validate.isInteger(txtmanv.getText())){
            JOptionPane.showMessageDialog(this, "Mã nhân viên phải là số nguyên dương");
            txtmanv.requestFocus();
            return;
        }
        if(!validate.isInteger(txtmanv.getText())||!validate.isPositiveInteger(txtsdt.getText())){
            JOptionPane.showMessageDialog(this, "Sdt phải là số nguyên");
            txtsdt.requestFocus();
            txtmanv.requestFocus();
            return;
    ...
    private void initComponents() {
        ...
        btThemnv.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        btSuanv.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        btSuanv.setText("Sửa");
        ...
        btXoanv.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        btXoanv.setText("Xóa");
