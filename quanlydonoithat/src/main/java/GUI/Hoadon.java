...
public class Hoadon extends javax.swing.JPanel {
    ...
    private void suahd(){
        ...
        if ("Đã hoàn thành".equals(trangThai) || "Đã thanh toán".equals(trangThai)) {
            JOptionPane.showMessageDialog(this, "Không thể sửa hóa đơn đã hoàn thành!");
            return;
        }
    ...
    private void xoahd(){
        try {
            ...
            if ("Đã hoàn thành".equals(trangThai) || "Đã thanh toán".equals(trangThai)) {
                JOptionPane.showMessageDialog(this, "Không thể xóa hóa đơn đã hoàn thành!");
                return;
            }
